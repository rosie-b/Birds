...
const birds = [
    ...
    status: 'Seriously endangered' ,
    image_url: '/images/kiwi.png',
    sound:'/sounds/male-ni-brown-kiwi.mp3' },
    ...
    status: 'Doing OK',
    image_url: '/images/ruru.jpg',
    sound:'/sounds/morepork-song.mp3' },
    ...
    status: 'Doing OK' ,
    image_url: '/images/tui.png',
    sound:'/sounds/tui-song-42.mp3' },
    ...
    image_url: '/images/hoiho.jpg',
    sound:'/sounds/yellow-eyed-penguin.mp3' },
    ...
    status: 'Seriously Endangered',
    image_url: '/images/takahe.png',
    sound:'/sounds/takahe-song-10.mp3' },
    ...
    status: 'Seriously Endangered',
    image_url: '/images/kea.png',
    sound:'/sounds/kea-song.mp3' },
    ...
    status: 'Somewhat Endangered',
    image_url: '/images/kereru.png',
    sound:'/sounds/nz-pigeon-song.mp3' },
    ...
    status: 'Seriously Endangered',
    image_url: '/images/whio.png',
    sound:'/sounds/blue-duck.mp3' },
    ...
    status: 'Somewhat Endangered',
    image_url: '/images/kaka.png',
    sound:'/sounds/south-island-kaka.mp3' }
]
